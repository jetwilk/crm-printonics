...
export function CustomerDetailPage() {
  ...
  if (!customer) {
    return <p className="text-red-500 text-center py-8">Cliente não encontrado.</p>;
  }
  ...
  return (
    <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6 shadow-sm">
        ...
        {customer.empresa && (
          <p className="text-gray-500 dark:text-gray-400 text-sm">{customer.empresa}</p>
        )}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setForm({
                    ...form,
                    orcamentoMaximo: e.target.value ? Number(e.target.value) : undefined,
                  })
                }
              />
            </div>
